...
<body class="fix-header card-no-border">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Statistic driver</h4>
    ...
    <script>
        ...
        function editStatistic driver(url){
            // alert(url)
            // showModal();
            $.ajax({
                url: url,
                ...
                success: function (data) {
                    ...
                    $("#formEditStatistic driver").attr("action", url);
