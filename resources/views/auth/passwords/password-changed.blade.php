                ...
                <div class="row width100 wizard-circle custom-step center text-left custom-left-side">
                    <div class="col-sm-12 col-md-12 col-12 m-b-30">
                        ...
                        <div class="form-horizontal form-material m-t-150 custom-verified" id="loginform">
                            ...
                            <h3 class="box-title m-b-0">{{ __('Votre mot de passe a été changé avec succès') }}</h3>
                            ...
                            <div class="form-group text-center">
                                <div class="col-xs-12">
                                    <a href="{{ route('logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();" class="btn btn-success btn-block text-uppercase waves-effect waves-light" type="submit">{{ __('Se connecter maintenant') }}</a>
                                </div>
                            </div>
