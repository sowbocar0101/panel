...
<body class="fix-header card-no-border">
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">@lang('custom.revenue')</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.php">@lang('custom.home')</a></li>
                        <li class="breadcrumb-item">@lang('custom.statistics')</li>
                        <li class="breadcrumb-item active">@lang('custom.revenue')</li>
                    </ol>
                </div>
                <div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <!-- <h4 class="card-title">Aprendizaje estadístico</h4> -->
    ...
    <script>
        ...
        function editStatistic earning(url){
            // alert(url)
            // showModal();
            $.ajax({
                url: url,
                ...
                success: function (data) {
                    ...
                    $("#formEditStatistic earning").attr("action", url);
