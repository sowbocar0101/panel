                            ...
                            <div class="card-body">
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content bg-gris">
                                            <div class="modal-header">
                                                <h4 class="modal-title" id="myModalLabel">@lang('custom.add_vehicle')</h4>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6 m-b-0">
                                                                <div class="form-group mb-3">
                                                                    <label class="mr-sm-2" for="designation">@lang('custom.vehicle_type')</label>
                                                            ...
                                                            <div class="col-md-6 m-b-0">
                                                                <div class="form-group mb-3">
                                                                    <label class="mr-sm-2" for="designation">@lang('custom.rental_price')</label>
                                                            ...
                                                            <div class="col-md-6 m-b-0">
                                                                <div class="form-group mb-3">
                                                                    <label class="mr-sm-2" for="designation">@lang('custom.number_of_place')</label>
                                                            ...
                                                            <div class="col-md-6 m-b-0">
                                                                <div class="form-group mb-3">
                                                                    <label class="mr-sm-2" for="designation">@lang('custom.number_of_vehicle')</label>
                                ...
                                <div id="vehicule-mod" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content bg-gris">
                                            <div class="modal-header">
                                                <h4 class="modal-title" id="myModalLabel">@lang('custom.edit_vehicle')s</h4>
                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                            </div>
                                ...
                                <div class="table-responsive m-t-10">
                                    <table id="example1" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        <thead class="custom-table-head">
                                            <tr>
                                                <th>N°</th>
                                                <th>@lang('custom.vehicle_type')</th>
                                                <th>@lang('custom.image')</th>
                                                <th>@lang('custom.price')</th>
                                                <th>@lang('custom.place')</th>
                                                <th>@lang('custom.number')</th>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu animated flipInX">
                                                                <button class="dropdown-item font-12" onclick="editVehicle(edit_vehicle_type_{{ $vehicle->id }}.value)">@lang('custom.edit')</button>
                                                                <input type="hidden" id="vehicle_type_del_msg_{{ $vehicle->id }}" value="@lang('custom.are_you_sure_you_want_to_delete_it') " />
                                                                <input type="hidden" id="vehicle_type_del_yes_{{ $vehicle->id }}" value="@lang('custom.yes')" />
                                                                <input type="hidden" id="vehicle_type_del_no_{{ $vehicle->id }}" value="@lang('custom.no')" />
                                                                <input type="hidden" id="vehicle_type_del_object_{{ $vehicle->id }}" value="@lang('custom.this_line')" />
                                                                <input type="hidden" id="vehicle_type_del_conf_{{ $vehicle->id }}" value="@lang('custom.confirmation')" />
                                                                <button class="dropdown-item font-12" onclick="showDelAlert(delete_vehicle_type_{{ $vehicle->id }}.id,vehicle_type_del_msg_{{ $vehicle->id }}.value+' '+vehicle_type_del_object_{{ $vehicle->id }}.value.toLowerCase(),vehicle_type_del_yes_{{ $vehicle->id }}.value,vehicle_type_del_no_{{ $vehicle->id }}.value,vehicle_type_del_conf_{{ $vehicle->id }}.value)">@lang('custom.delete')</button>
                                                                <form method="POST" action="{{ route('vehiclerentals.destroy') }}">
                                                                    {{ csrf_field() }}
                                                                    {{ method_field('GET') }}
                                                                    <input type="hidden" id="" name="status" value="0">
                                                                    <input type="hidden" id="" name="vehicle_type_id" value="{{ $vehicle->id }}">
                                                                    <button type="submit" style="display:none;" id="delete_vehicle_type_{{ $vehicle->id }}">@lang('custom.delete')</button>
                                                                </form>
                                                                <input type="hidden" id="edit_vehicle_type_{{ $vehicle->id }}" name="" value="{{ route('vehiclerentals.show', [$vehicle->id]) }}">
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
